...
- Uso interno, em comunicados e materiais da Supporte.
- Não distorcer, recolorir ou editar o desenho das marcas.
- Não usar fora do contexto de comunicação sobre a própria certificação ou parceria.
- Qualquer dúvida sobre uso, seguir o manual de marca do dono de cada logo (links abaixo).
...
- `abol-simbolo.svg` / `abol-simbolo.png`: só o símbolo (quadrado verde com "ABOL").
- `abol-completo.svg` / `abol-completo.png`: símbolo + nome completo da associação.
- Fonte oficial: SVG obtido diretamente do site da ABOL. Capturado em 08/2026.

Todos os PNGs estão em fundo transparente, alta resolução.
